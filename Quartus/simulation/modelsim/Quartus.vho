...
-- Design Ports Information
-- ADC_CLK_10	=>  Location: PIN_AB6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- MAX10_CLK1_50	=>  Location: PIN_AB20,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF \hello-adc\ IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
